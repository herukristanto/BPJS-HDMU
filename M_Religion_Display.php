          ...
          <button type="button" class="btn" id="myBtn">Search</button>
        	...
        	<table>
        		...
        		<tr>
        			<td>Nama</td>
        			<td> : </td>
        			<td><input type="text" id="name" name="name" maxlength="30" disabled></td>
        		</tr>
        		<tr>
        			<td>Aktif</td>
        			<td> : </td>
        			<td><input type="radio" name="statrel" id="aktif" checked disabled> Aktif</td>
        			<td><input type="radio" name="statrel" id="nonaktif" disabled> Non-Aktif</td>
        		</tr>
        	</table>
