...
<div id="myModal" class="modala">
  <div class="modala-content">
    <div class="modala-header">
      ...
      <h2>Filter Data Group Diagnosis</h2>
    </div>
...
$(document).ready(function(){ //when click button
  $("#saringtabel").click(function(){
    var url = 'M_Group_Diag_Table.php?katakunci1='+$("#katakunci1").val()+'&katakunci2='+$("#katakunci2").val();
    url = url.replace(" ","%20");
...
function cekKataKunci(){
  ...
  window.location.href='M_Group_Diag_Search.php?katakunci1=' + katakunci1 + '&katakunci2=' + katakunci2;
}
