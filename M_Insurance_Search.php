    ...
    <div class="modala-body">
      ...
      <table>
        ...
        <tr>
          ...
          <td align="right"><button type="button" class="btn" id="saringtabel">Saring</button></td>
        </tr>
      </table>
...
$(document).ready(function(){
  ...
  {
    var url = 'M_Insurance_Table.php?katakunci1='+$("#katakunci1").val()+'&katakunci2='+$("#katakunci2").val();
    url = url.replace(" ","%20");
