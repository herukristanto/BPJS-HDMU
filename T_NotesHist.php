          ...
          <table class="layer1">
            <tr>
              ...
              <td style="padding-left: 10px;vertical-align: top;">
                ...
                <iframe id="tableNotes" name="tableNotes" src="NotesHistTable.php?patno=<?php echo $patno; ?>&caseno=<?php echo $caseno; ?>"></iframe>
              </td>
            </tr>
          </table>
...
<script>
  ...
  function getNotes(patno, caseno){
    ...
    document.getElementById('tableNotes').src = 'NotesHistTable.php?patno='+patno+'&caseno='+caseno;
  }
