...
<?php
	...
	If ($Rd == 'Detail') 
	{ 
		$query = "SELECT * FROM V_StockUsage WHERE Case_Date >= CONVERT(DATETIME,'".$DateF." 00:00:00',102) AND Case_Date <= CONVERT(DATETIME,'".$DateT." 00:00:00',102) and Stock = 'X' ORDER BY Case_Date";
