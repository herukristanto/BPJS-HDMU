...
<head>
  <meta charset="utf-8">
  <title>Group Diagnosis - Create</title>
      ...
      <div class="container">
        <div class="row">
          <div class="span12 mainPage">
            <button type="button" class="btn" id="upData" onclick="savegroup();">Save</button>
            ...
            <table>
              <tr>
                ...
                <td width="15"> : </td>
                <td><input type="text" id="group_id" name="group_id" maxlength="50"></td>
              </tr>
              <tr>
                <td>Deskripsi</td>
                <td> : </td>
