        ...
        <div class="span12 mainPage">
          ...
          <table>
            ...
            <tr>
              <td>Nama Ruangan</td>
              <td> : </td>
              <td><input type="text" id="nameroom" name="name" maxlength="50" disabled></td>
            </tr>
            <tr>
              <td>Aktif</td>
              <td> : </td>
              <td><input type="radio" name="statroom" id="aktif" checked disabled> Aktif</td>
              <td><input type="radio" name="statroom" id="nonaktif" disabled> Non-Aktif</td>
            </tr>
          </table>
