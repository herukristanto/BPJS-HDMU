...
<head>
<meta charset="utf-8">
<title>Report Collection - Detail</title>
						...
						<div id="exportarea">
							...
							<table id="myTable">
								<tr>
									...
									<th width="110">Nomor Kwitansi</th>
									<th>Nomor RM</th>
									<th>Nomor Kasus</th>
								...
								<?php
									...
									$que = "
										select *, '1' as det from V_POSTrans
										...
										Select *, '-1' as det from V_POSRefund 
										where Create_By = '".$user."' 
										and CTerminal = '".$terminal."' 
										and CSession = '".$session."' 
										and CONVERT(varchar, Create_Time, 111) = '".$tanggal."'";
									...
									while($pos = sqlsrv_fetch_array($que_exe, SQLSRV_FETCH_ASSOC)){
										
										echo "
											<tr>
												<td style='text-align:center;'>".$pos['Create_Time']->format('d-m-Y H:i:s')."</td>
												<td style='text-align:center;'>".$pos['Pay_Id']."</td>
												<td>".$pos['Pat_No']."</td>
												<td>".$pos['Case_No']."</td>
												<td>".$pos['Payment']."</td>
												<td>".$pos['Card_No']."</td>
												<td style='text-align:right;'>".number_format($pos['Amount'] * $pos['det'],0,",",".")."</td>
											</tr>
										";
									}
								?>
