          ...
          <table class="layer1">
            <tr>
              ...
              <td style="padding-left: 10px;vertical-align: top;">
                ...
                <iframe id="tableNotes" name="tableNotes" src="NotesEditTable.php?patno=<?php echo $patno; ?>&caseno=<?php echo $caseno; ?>"></iframe>
              </td>
            </tr>
          </table>
...
<script>
  ...
  function getNotes(patno, caseno){
    ...
    document.getElementById('tableNotes').src = 'NotesEditTable.php?patno='+patno+'&caseno='+caseno;
  }
  ...
  function back2case(){
    window.location.href = "T_Case.php?case=<?php echo $caseno; ?>";
  }
</script>
