          ...
          <form method="post" action="M_Insurance_Save.php" onsubmit="return saveasuransi();">
            ...
            <table>
              ...
              <tr hidden>
                <td>Aktif</td>
                <td> : </td>
                <td><input type="radio" id="aktif" name="statasuransi" checked>Aktif</td>
                <td><input type="radio" id="nonaktif" name="statasuransi">Tidak Aktif</td>
              </tr>
            </table>

            <input type="hidden" name="hidmode" id="hidmode" value="baru" />
          </form>
