    ...
    <div class="container">
      <div class="row">
        <div class="span12 mainPage">
					...
					<button type="button" class="btn" id="upData" onclick="savedokter();" disabled>Save</button>
          ...
          <button type="button" class="btn closeMstr">Exit</button>
					...
					<?php include "M_Doctor_Search.php"; ?>
        </div>
        <!-- /span12 -->
      </div>
      <!-- /row -->
...
<script>
	function savedokter(){
		...
		namdokter = document.getElementById('namadok').value;
		...
		if (namdokter) {
			window.location.href='M_Doctor_Save.php?iddok=' + iddok + '&namadok=' + namdokter + '&statdok=' + statdok + '&simpan=' + simpan;
		} else {
