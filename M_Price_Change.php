      ...
      <div class="row">
        <div class="span12 mainPage">
          <button type="button" class="btn" id="myBtn">Search</button>
        	<button type="button" class="btn" id="upData" onclick="saveprice();" disabled>Save</button>
        	<button type="button" class="btn" onclick="clearprice();">Clear</button>
          <button type="button" class="btn closeMstr">Exit</button>
        	...
        	<table>
        		...
        		<tr>
        			<td>Valid From</td>
        			<td> : </td>
        			<td><input type="text" class="datepicker" id="datepicker" name="validfrom"></td>
        		</tr>
        		<tr>
        			<td>Valid To</td>
        			<td> : </td>
        			<td><input type="text" class="datepicker" id="datepicker1" name="validto"></td>
        		</tr>
        	</table>
